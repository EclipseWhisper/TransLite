...
(function () {
  ...
  function ensureUiStyle() {
    ...
    s.textContent =
      ...
      '#ms-auto-zh-btn-core{' +
        'position:relative!important;width:36px!important;height:36px!important;border-radius:18px!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;opacity:.72!important;' +
        'background:radial-gradient(circle at 30% 18%,rgba(255,255,255,.98),rgba(255,255,255,.44) 38%,rgba(220,232,247,.24) 72%,rgba(255,255,255,.18))!important;border:1px solid rgba(255,255,255,.86)!important;' +
        'box-shadow:0 18px 38px rgba(32,39,55,.16),0 6px 14px rgba(32,39,55,.09),inset 0 1px 0 rgba(255,255,255,.92),inset 0 -1px 0 rgba(255,255,255,.28)!important;' +
        'backdrop-filter:blur(52px) saturate(240%) brightness(1.14)!important;-webkit-backdrop-filter:blur(52px) saturate(240%) brightness(1.14)!important;pointer-events:none!important;' +
        'transition:transform .18s cubic-bezier(.2,.8,.2,1),box-shadow .18s ease,background .18s ease!important;' +
      '}' +
      '#ms-auto-zh-btn-core:before{content:""!important;position:absolute!important;left:3px!important;right:3px!important;top:2px!important;height:50%!important;border-radius:999px!important;background:linear-gradient(180deg,rgba(255,255,255,.92),rgba(255,255,255,.16) 70%,rgba(255,255,255,0))!important;pointer-events:none!important;}' +
      '#ms-auto-zh-btn-core:after{content:""!important;position:absolute!important;width:22px!important;height:22px!important;right:-7px!important;bottom:-6px!important;border-radius:50%!important;background:rgba(255,255,255,.38)!important;filter:blur(2.2px)!important;pointer-events:none!important;}' +
      ...
      '#ms-auto-zh-btn.ms-auto-zh-off #ms-auto-zh-btn-core{background:radial-gradient(circle at 30% 18%,rgba(255,255,255,.98),rgba(255,255,255,.44) 38%,rgba(220,232,247,.24) 72%,rgba(255,255,255,.18))!important;box-shadow:0 18px 38px rgba(32,39,55,.16),0 6px 14px rgba(32,39,55,.09),inset 0 1px 0 rgba(255,255,255,.92),inset 0 -1px 0 rgba(255,255,255,.28)!important;}' +
      '#ms-auto-zh-btn-text{' +
        'position:relative!important;z-index:1!important;display:block!important;width:36px!important;height:36px!important;color:#050505!important;text-align:center!important;text-shadow:0 1px 0 rgba(255,255,255,.9)!important;' +
        'font:950 15px/36px MiSans,"MiSans VF","Xiaomi Sans",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;pointer-events:none!important;' +
      '}' +
      '#ms-auto-zh-tip{' +
      ...
      '#ms-auto-zh-menu{' +
        'position:fixed!important;z-index:2147483647!important;width:222px!important;max-width:calc(100vw - 12px)!important;padding:7px!important;border-radius:24px!important;' +
        'background:linear-gradient(180deg,rgba(247,247,248,.92),rgba(239,240,244,.84))!important;border:1px solid rgba(255,255,255,.86)!important;' +
        'backdrop-filter:blur(50px) saturate(220%) brightness(1.06)!important;-webkit-backdrop-filter:blur(50px) saturate(220%) brightness(1.06)!important;' +
        'box-shadow:0 18px 44px rgba(26,32,46,.16),0 6px 15px rgba(26,32,46,.075),inset 0 1px 0 rgba(255,255,255,.9)!important;color:#050505!important;box-sizing:border-box!important;' +
      ...
      '.ms-auto-zh-label{padding:5px 9px 4px!important;font:900 11px/1 MiSans,"MiSans VF","Xiaomi Sans",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;color:#9699aa!important;}' +
      '.ms-auto-zh-card{overflow:hidden!important;border-radius:20px!important;background:rgba(255,255,255,.95)!important;border:1px solid rgba(255,255,255,.98)!important;box-shadow:0 7px 18px rgba(30,36,50,.05),inset 0 1px 0 rgba(255,255,255,1)!important;}' +
      '.ms-auto-zh-row{width:100%!important;min-height:42px!important;padding:6px 8px!important;border:0!important;border-radius:0!important;background:transparent!important;color:#050505!important;text-align:left!important;display:grid!important;grid-template-columns:26px minmax(0,1fr) auto!important;align-items:center!important;column-gap:7px!important;-webkit-appearance:none!important;appearance:none!important;touch-action:manipulation!important;}' +
      '.ms-auto-zh-row:active{background:rgba(0,0,0,.045)!important;}' +
      '.ms-auto-zh-row.ms-auto-zh-selected{background:rgba(55,132,245,.08)!important;}' +
      '.ms-auto-zh-card .ms-auto-zh-row+.ms-auto-zh-row{border-top:1px solid rgba(0,0,0,.045)!important;}' +
      '.ms-auto-zh-ico{width:24px!important;height:24px!important;border-radius:9px!important;display:flex!important;align-items:center!important;justify-content:center!important;background:transparent!important;color:#000!important;font:950 16px/1 MiSans,"MiSans VF","Xiaomi Sans",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;}' +
      '.ms-auto-zh-mid{min-width:0!important;}' +
      '.ms-auto-zh-name{display:block!important;color:#050505!important;font:950 14px/1.1 MiSans,"MiSans VF","Xiaomi Sans",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;letter-spacing:-.018em!important;}' +
      '.ms-auto-zh-desc{display:block!important;margin-top:2px!important;color:#686a70!important;font:700 10.5px/1.12 MiSans,"MiSans VF","Xiaomi Sans",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;}' +
      '.ms-auto-zh-val{font:850 11.5px/1.05 MiSans,"MiSans VF","Xiaomi Sans",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;color:#8f9197!important;white-space:nowrap!important;display:flex!important;align-items:center!important;gap:4px!important;}' +
      ...
      '.ms-auto-zh-switch{position:relative!important;width:38px!important;height:23px!important;border-radius:999px!important;background:#d7d9df!important;box-shadow:inset 0 1px 2px rgba(0,0,0,.07)!important;display:inline-block!important;}' +
      '.ms-auto-zh-switch:after{content:""!important;position:absolute!important;width:19px!important;height:19px!important;border-radius:50%!important;left:2px!important;top:2px!important;background:#fff!important;box-shadow:0 2px 5px rgba(0,0,0,.18)!important;transition:left .18s cubic-bezier(.2,.8,.2,1)!important;}' +
      '.ms-auto-zh-switch.on{background:#3488f6!important;}' +
      '.ms-auto-zh-switch.on:after{left:17px!important;}' +
